...
_query = format["SELECT playerid, name FROM skills WHERE playerid='%1'",_uid];
...
_query = format["INSERT INTO skills (name, playerid, miningexp, farmingexp) VALUES('%1', '%2', '0', '0')",
	_name,
	_uid
];

diag_log "----- Sucessfully received EXP information -----";

/*
	File: important farming scripts SERVERFILES
	Author: Zannaza from www.arma3-life.com/ [Arma 3 Life]
	Description: Most important scripts to get farming working
	(C) A3L
*/
...
["opium Poppy","Oleander2",600,1.5,900],

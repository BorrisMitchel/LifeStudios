...
[profileName,getPlayerUID player,"MenuBasedHack_DISPLAY_3030"] remoteExec ["SPY_fnc_cookieJar",2];
[profileName,"Menu Hack: DISPLAY 3030 (Wookie Menu etc)"] remoteExec ["SPY_fnc_notifyAdmins",0];
	sleep 0.5;
...
[profileName,getPlayerUID player,"MenuBasedHack_DISPLAY_64_C_101"] remoteExec ["SPY_fnc_cookieJar",2];
[profileName,"Menu Hack: DISPLAY 64 CONTROL 101"] remoteExec ["SPY_fnc_notifyAdmins",0];
	sleep 0.5;
	["SpyGlass",false,false] call BIS_fnc_endMission;
};
...
[profileName,getPlayerUID player,"MenuBasedHack_DISPLAY_162"] remoteExec ["SPY_fnc_cookieJar",2];
[profileName,"Menu Hack: DISPLAY 162 (Lystic & Bobby Menu Hack)"] remoteExec ["SPY_fnc_notifyAdmins",0];
	sleep 0.5;
	["SpyGlass",false,false] call BIS_fnc_endMission;
};
...
[profileName,getPlayerUID player,"MenuBasedHack_RscDisplayRemoteMissions"] remoteExec ["SPY_fnc_cookieJar",2];
[profileName,"Menu Hack: RscDisplayRemoteMissions"] remoteExec ["SPY_fnc_notifyAdmins",0];
	sleep 0.5;
	["SpyGlass",false,false] call BIS_fnc_endMission;
};
...
[] spawn {
	...
	closeDialog 0;
[profileName,getPlayerUID player,"MenuBasedHack_RscDisplayDebugPublic"] remoteExec ["SPY_fnc_cookieJar",2];
[profileName,"Menu Hack: RscDisplayDebugPublic"] remoteExec ["SPY_fnc_notifyAdmins",0];
	sleep 0.5;
	["SpyGlass",false,false] call BIS_fnc_endMission;
};
...
[profileName,getPlayerUID player,"MenuBasedHack_RscDisplayConfigureControllers"] remoteExec ["SPY_fnc_cookieJar",2];
[profileName,"Menu Hack: RscDisplayConfigureControllers (JME 313)"] remoteExec ["SPY_fnc_notifyAdmins",0];
			sleep 0.5;
			["SpyGlass",false,false] call BIS_fnc_endMission;
		};
		closeDialog 0;
...
[] spawn {
	while {true} do {
		...
		closeDialog 0;
[profileName,getPlayerUID player,"MenuBasedHack_RscDisplayArsenal"] remoteExec ["SPY_fnc_cookieJar",2];
[profileName,"Menu Hack: BIS Arsenal"] remoteExec ["SPY_fnc_notifyAdmins",0];
		sleep 0.5;
		["SpyGlass",false,false] call BIS_fnc_endMission;
	};
};

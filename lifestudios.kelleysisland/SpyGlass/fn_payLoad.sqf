...
[profileName,getPlayerUID player,(configName _patchEntry)] remoteExec ["SPY_fnc_cookieJar",2];
[profileName,format["Unknown Addon Patch: %1",(configName _patchEntry)]] remoteExec ["SPY_fnc_notifyAdmins",0];
				sleep 0.5;
...
[profileName,getPlayerUID player,"Modified_MPInterrupt"] remoteExec ["SPY_fnc_cookieJar",2];
[profileName,"Devcon like executor detected"] remoteExec ["SPY_fnc_notifyAdmins",0];
		sleep 0.5;
		["SpyGlass",false,false] call BIS_fnc_endMission;
	};
} foreach _children;
...
[profileName,getPlayerUID player,"Modified_RscDisplayInventory_onLoad"] remoteExec ["SPY_fnc_cookieJar",2];
[profileName,"Modified RscDisplayInventory_onLoad (CheatEngine injection)"] remoteExec ["SPY_fnc_notifyAdmins",0];
	sleep 0.5;
	["SpyGlass",false,false] call BIS_fnc_endMission;
};
...
[profileName,getPlayerUID player,"Modified_RscDisplayInventory_onUnload"] remoteExec ["SPY_fnc_cookieJar",2];
[profileName,"Modified RscDisplayInventory_onUnload (CheatEngine injection)"] remoteExec ["SPY_fnc_notifyAdmins",0];
	sleep 0.5;
	["SpyGlass",false,false] call BIS_fnc_endMission;
};
...
[profileName,getPlayerUID player,"No_recoil_hack"] remoteExec ["SPY_fnc_cookieJar",2];
[profileName,"No recoil hack"] remoteExec ["SPY_fnc_notifyAdmins",0];
			sleep 0.5;
			["SpyGlass",false,false] call BIS_fnc_endMission;
		};
		sleep 1.5;

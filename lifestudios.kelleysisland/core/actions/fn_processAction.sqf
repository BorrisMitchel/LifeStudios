...
_itemInfo = switch (_type) do
{
	...
	case "diamond": {["diamondrock","diamondc",1350,(localize "STR_Process_Diamond")];};
	case "heroin": {["opium","heroinp",1750,(localize "STR_Process_Heroin")];};
	case "copper": {["copperore","copper_r",750,(localize "STR_Process_Copper")];};
	case "iron": {["ironrock","iron_r",1120,(localize "STR_Process_Iron")];};
	...
	case "cement": {["normalrock","cement",350,(localize "STR_Process_Cement")];};
	default {[];};
};

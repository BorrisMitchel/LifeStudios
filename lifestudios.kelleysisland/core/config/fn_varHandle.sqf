...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "normalrock": {"life_inv_normalrock"};
			case "ironrock": {"life_inv_ironrock"};
			case "coalrock": {"life_inv_coalrock"};
			case "diamondrock": {"life_inv_diamondrock"};
			case "paperlog": {"life_inv_paperlog"};
			case "olivelog": {"life_inv_olivelog"};
			case "ficuslog": {"life_inv_ficuslog"};
			case "batterypack": {"life_inv_batterypack"};
			...
			case "Earplugs": {"life_inv_earplugs"};
			case "repairkit": {"life_inv_repairkit"};
			case "grantdriverlicence": {"life_inv_grantdriverlicence"};
			case "grantgunlicence": {"life_inv_grantgunlicence"};
		};
	};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_normalrock": {"normalrock"};
			case "life_inv_ironrock": {"ironrock"};
			case "life_inv_coalrock": {"coalrock"};
			case "life_inv_diamondrock": {"diamondrock"};
			case "life_inv_paperlog": {"paperlog"};
			case "life_inv_olivelog": {"olivelog"};
			case "life_inv_ficuslog": {"ficuslog"};
			case "life_inv_batterypack": {"batterypack"};
			...
			case "life_inv_repairkit": {"repairkit"};

...
switch (_var) do
{
	...
	case "life_inv_normalrock": {(localize "STR_Item_normalrock")};
	case "life_inv_ironrock": {(localize "STR_Item_ironrock")};
	case "life_inv_coalrock": {(localize "STR_Item_coalrock")};
	case "life_inv_diamondrock": {(localize "STR_Item_diamondrock")};
	case "life_inv_paperlog": {(localize "STR_Item_Paperlog")};
	case "life_inv_olivelog": {(localize "STR_Item_olivelog")};
	case "life_inv_ficuslog": {(localize "STR_Item_ficuslog")};
	case "life_inv_batterypack": {(localize "STR_Item_batterypack")};
	...
	case "life_inv_earplugs": {"Earplugs"};
	case "life_inv_repairkit": {"Repair Kit"};
	case "life_inv_grantgunlicence": {"grantgunlicence"};
	case "life_inv_grantdriverlicence": {"grantdriverlicence"};
	...
	case "license_civ_fcl": {(localize "STR_License_Firearm")};
	...
	case "license_civ_fsl": {"Firearm Sell License"};

...
_Btn10 ctrlSetText "Police Computer";
_Btn10 buttonSetAction "createDialog 'A3L_PolicePC'";

//Strip search function
_Btn11 ctrlSetText "Strip Search";
[] remoteExec [""life_fnc_stripsearch"",life_pInact_curTarget]; closeDialog 0;";

_Btn12 ctrlSetText "Revoke Gun";
[] remoteExec [""license_civ_fcl = false;"",life_pInact_curTarget]; closeDialog 0;";

_Btn13 ctrlSetText "Revoke Driver";
[] remoteExec [""license_civ_driver = false;"",life_pInact_curTarget]; closeDialog 0;";

//Check that you are near a place to jail them.
if(!((player distance (getMarkerPos "jail_marker") < 50) OR  (player distance (getMarkerPos "UC_Cop_Spawn") < 30))) then 
{

/*---------------------------------------------------------------------------
Author Scotty from Realmenofgenius 11/01/2015 // Tweaked for A3L by: Oscar Rogain
---------------------------------------------------------------------------*/
private["_hgItems","_holder","_items","_pwItems","_safeItems","_swItems","_weps"];

_safeItems = ["FirstAidKit","ItemMap","ItemCompass","ItemGPS","ItemWatch","NVGoggles","Rangefinder","Binocular"];

player switchMove "amovpknlmstpsnonwnondnon_amovpknlmstpsraswlnrdnon";
[player,"amovpknlmstpsnonwnondnon_amovpknlmstpsraswlnrdnon"] remoteExec ["life_fnc_animSync",0];

...
[] spawn
{
	...
	{
[0,format[localize "STR_Cop_Ticket_Refuse",profileName]] remoteExec ["life_fnc_broadcast",west];
[1,format[localize "STR_Cop_Ticket_Refuse",profileName]] remoteExec ["life_fnc_broadcast",life_ticket_cop];
	};
};

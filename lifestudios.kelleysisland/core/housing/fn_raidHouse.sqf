...
if(_value > 0) then {
[0,format[localize "STR_House_Raid_Successful",[_value] call life_fnc_numberText]] remoteExec ["life_fnc_broadcast",0];
	life_atmcash = life_atmcash + _value;
	_house setVariable["Trunk",[_houseInvData,_houseInvVal],true];
[_house] remoteExec ["TON_fnc_updateHouseTrunk",2];
} else {

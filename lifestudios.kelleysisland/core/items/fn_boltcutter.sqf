...
[[1,2],localize "STR_ISTR_Bolt_AlertFed"] remoteExec ["life_fnc_broadcast",0];
} else {
[0,format[localize "STR_ISTR_Bolt_AlertHouse",profileName]] remoteExec ["life_fnc_broadcast",0];
};
...
["You've successfully unlocked this house!",20,"green"] call A3L_Fnc_Msg;
};} else {
["You've failed to unlocked this house.",20,"red"] call A3L_Fnc_Msg;
};
[getPlayerUID player,profileName,"459"] remoteExec ["life_fnc_wantedAdd",2];

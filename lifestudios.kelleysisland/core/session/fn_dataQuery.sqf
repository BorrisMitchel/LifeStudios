...
[_uid,_side,_sender] remoteExecCall ["DB_fnc_queryRequest",2];
[_uid,_side,_sender] remoteExecCall ["DB_fnc_queryPhRequest",2];
[_uid,_side,_sender] remoteExecCall ["DB_fnc_queryExpRequest",2];

...
_clothes = switch (life_clothing_store) do
{
	...
	case "brucecop": {[_selection] call life_fnc_clothing_dtu;};
	case "hrtcop": {[_selection] call life_fnc_clothing_hrt;};
	case "swatcop": {[_selection] call life_fnc_clothing_swat;};
	case "cop": {[_selection] call life_fnc_clothing_cop;};
	case "siu": {[_selection] call life_fnc_clothing_siu;};
	//case "dojsiu": {[_selection] call life_fnc_clothing_doj;};
